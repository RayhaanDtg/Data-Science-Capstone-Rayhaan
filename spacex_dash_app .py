...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                html.Div( dcc.Dropdown(id='site-dropdown',
                                            ...
                                            value='ALL',
                                            placeholder="Choose launch sites",
                                            searchable=True
                                            )),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        site_data = filtered_df.groupby('Launch Site')['class'].value_counts().rename('count').reset_index()
...
def update_scatter_chart(selected_site, payload_range):
    if selected_site == 'ALL':
        ...
        fig = px.scatter(filtered_df, x='Payload Mass (kg)', y='class', color='Booster Version Category', title=f'Launch Site: {selected_site}')
